...
export class Suffix extends React.Component {
    ...
    render () {
        ...
        const dropdownItems = [
            <DropdownItem key="import" component="button" onClick={this.showImportModal} title={_("Import an LDIF file to initialize the database")}>
                {_("Initialize Suffix")}
            </DropdownItem>,
            <DropdownItem key="export" component="button" onClick={this.showExportModal} title={_("Export the database to an LDIF file")}>
                {_("Export Suffix")}
            </DropdownItem>,
            <DropdownItem key="reindex" component="button" onClick={this.showReindexConfirm} title={_("Reindex the entire database")}>
                {_("Reindex Suffix")}
            </DropdownItem>,
            <DropdownItem key="subSuffix" component="button" onClick={this.showSubSuffixModal} title={_("Create a sub-suffix under this suffix")}>
                {_("Create Sub-Suffix")}
            </DropdownItem>,
            <DropdownItem key="dbLink" component="button" onClick={this.showLinkModal} title={_("Create a database chaining link subtree")}>
                {_("Create Database Link")}
            </DropdownItem>,
            <DropdownSeparator key="separator" />,
            <DropdownItem key="deleteSuffix" component="button" onClick={this.showDeleteConfirm} title={_("This will permanently delete the database")}>
                {_("Delete Suffix")}
            </DropdownItem>,
        ];
