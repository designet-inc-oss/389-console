...
class AddNewAci extends React.Component {
    ...
    render () {
        ...
        const bindRulesComponent = (
            <>
                <TextContent>
                    <Text component={TextVariants.h3}>{_("Define the Bind Rules")} <Tooltip
                        position="bottom"
                        content={
                            <div>
        ...
        const targetAttrComponent = (
            <>
                <TextContent>
                    <Text component={TextVariants.h3}>{_("Choose the Target Attributes")} <Tooltip
                        position="bottom"
                        content={
                            <div>
        ...
        const targetFilterComponent = (
            <>
                <TextContent>
                    <Text component={TextVariants.h3}>{_("Target Filter ")}<Tooltip
                        position="bottom"
                        content={
                            <div>
        ...
        const moddnComponent = (
            <>
                <TextContent>
                    <Text component={TextVariants.h3}>{_("Moving Entries")} <Tooltip
                        position="bottom"
                        content={
                            <div>
                                {_("If you need to control access for moving an entry between specific subtrees then use the target_from and target_to keywords. These keywords use LDAP URL's to specify the database resources/locations: ldap ldap:")}
                            </div>
                        }
                    >
                        <a className="ds-font-size-md"><InfoCircleIcon className="ds-info-icon" /></a>
                        ...
                        <Grid className="ds-margin-top">
                            ...
                            <GridItem span={2} className="ds-left-margin">
                                <FormSelect id="userattrBindType" value={this.state.userattrBindType} onChange={(str, e) => { this.handleChange(e)}} aria-label="FormSelect Input">
                                    <FormSelectOption key="USERDN" value="USERDN" label={_("USERDN")} />
                                    <FormSelectOption key="GROUPDN" value="GROUPDN" label={_("GROUPDN")} />
                                    <FormSelectOption key="ROLEDN" value="ROLEDN" label={_("ROLEDN")} />
                                    <FormSelectOption key="SELFDN" value="SELFDN" label={_("SELFDN")} />
                                    <FormSelectOption key="LDAPURL" value="LDAPURL" label={_("LDAPURL")} />
                                </FormSelect>
                            </GridItem>
