            ...
            <>
                ...
                <div className="ds-indent">
                    ...
                    <TextContent className="ds-margin-top-xlg">
                        ...
                        <Text component={TextVariants.h6} className="ds-margin-top-lg ds-font-size-md">
                            <b>{_("Posix Account")}</b>{_(" - This type of user entry uses a similar set of objectclasses as the <i>Basic Account</i>(nsPerson, nsAccount, nsOrgPerson, and posixAccount), but it includes POSIX attributes like:")} 
                    ...
                    <Grid>
                        <GridItem className="ds-margin-top" span={12}>
                            <Alert
                                ...
                                title={myTitle}
                            >
                                <b>{_("Entry DN:")}&nbsp;&nbsp;&nbsp;</b>{(namingAttr ? namingAttr : "??????")}={namingVal ? namingVal : "??????"},{this.props.wizardEntryDn}
                            </Alert>
                        </GridItem>
